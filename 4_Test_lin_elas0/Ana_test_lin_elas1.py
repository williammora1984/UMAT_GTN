...
#Y: dependent values
#Von Mises Data
X1, Y1= import_dataset("dVM11.csv")
X2, Y2= import_dataset("dVM12.csv")
X3, Y3= import_dataset("dVM13.csv")
X4, Y4= import_dataset("dVM14.csv")
X5, Y5= import_dataset("dVM15.csv")

#GTN data
X1G, Y1G= import_dataset("dGN11.csv")
X2G, Y2G= import_dataset("dGN12.csv")
X3G, Y3G= import_dataset("dGN13.csv")
X4G, Y4G= import_dataset("dGN14.csv")
X5G, Y5G= import_dataset("dGN15.csv")
...
file_name="T_Iso_Stress_strain1.png"
